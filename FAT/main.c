...
int main() {
    // Initialize file system with a larger buffer size
    FileSystem fs;
    fs.buffer_size = 10240; // Increase buffer size to 10240 bytes
    ...
    // Manually create "CASA" directory in the root
